...
1. As the Administrator I want to filter rules by name !!
...
1. As the Administrator I want to receive real-time updates from sensors
...
1. As the Administrator I want to navigate between interfaces intuitively